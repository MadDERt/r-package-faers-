...
Alice Anonymous\,\textsuperscript{1,2}, Bob
Security\,\textsuperscript{1}
}

\address{
\textsuperscript{1}Some Institute of Technology, Department, Street,
City, State, Zip\\
\textsuperscript{2}Another University Department, Street, City, State,
Zip\\
}
